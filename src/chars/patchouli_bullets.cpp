...
#include "../utils.h"
#include "patchouli_bullets.h"
#include "patchouli.h"
#include <math.h>

bool patchouli_bullets::sub_5269B0()
{
...
bool patchouli_bullets::sub_526870(uint16_t subseq)
{
    c_meta * par = chrt;
...
void patchouli_bullets::func10()
{
    ...
    case 805:
        ...
        case 8:
        {
            char_pachou *pachou = (char_pachou *)chrt;
            if ( chrt->health <= 0 || enemy->health <= 0 )
            {
                pachou->field_892--;
                pachou->field_8BC[field_3AC + 1] = 0;
                set_subseq(6);
                return;
            }
            if ( pachou->field_8BC[field_3AC + 1] )
            {
                next_subseq();
                pachou->field_8BC[field_3AC + 1] = 0;
                return;
            ...
            {
                pachou->field_89C[field_3AC] = x;
                pachou->field_8AC[field_3AC] = y;
                ...
                if ( chrt->get_seq() == 566 || (chrt->get_seq() == 569 && pachou->field_8BC[0] == 1) )
                {
                    pachou->field_892--;
                    set_seq(834);
                    set_subseq(7);
        ...
        if ( get_elaps_frames() == 0 && get_frame_time() == 0 && get_frame() == 0 && get_subseq() == 5 )
        {
            ...
            if ( pachou->field_892 <= tmp )
            {
                field_3AC = pachou->field_892;
                pachou->field_892++;
                pachou->field_89C[field_3AC] = x;
                pachou->field_8AC[field_3AC] = y;
                set_subseq(8);
    ...
    case 827:
        ...
        case 3:
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    int32_t doll = pachou->field_892;
                    if ( doll > 0 )
                    {
                        if ( SQR(y - pachou->field_8AC[doll - 1]) + SQR(x - pachou->field_89C[doll - 1]) <= SQR(35) )
                        {
                            x = pachou->field_89C[doll - 1];
                            y = pachou->field_8AC[doll - 1];
                            pachou->field_8BC[doll] = 1;
                            if ( doll == 1 )
                            {
                            ...
                            {
                                addition[1] = -atan2_deg(pachou->field_8AC[doll - 2] - y, (pachou->field_89C[doll - 2] - x) * dir);
                            }
                            pachou->field_892--;
                            field_190 = 0;
                            field_194 = 1;
        ...
        case 6:
        {
            ...
            if ( doll > 0 )
            {
                if ( SQR(x - pachou->field_89C[doll - 1]) + SQR(y - pachou->field_8AC[doll - 1]) <= SQR(15) )
                {
                    x = pachou->field_89C[doll - 1];
                    y = pachou->field_8AC[doll - 1];
                    pachou->field_8BC[doll] = 1;
    ...
    case 830:
        if ( get_subseq() == 0 )
        {
            ...
            dir = chrt->dir;
            char_pachou *pachou = (char_pachou *)chrt;
            float angl = (4 * pachou->field_898) + addition[2] * 120.0;
            ...
            if ( (chrt->get_seq() == 565 || chrt->get_seq() == 567)
                    && pachou->field_8BC[0] == 1
                    && addition[2] == pachou->field_890[0])
            {
                pachou->field_890[0]--;
                pachou->field_8BC[0] = 0;
                set_seq(831);
                set_subseq(0);
    ...
    case 834:
        ...
        {
            char_pachou *pachou = (char_pachou *)chrt;
            float angl = 3 * pachou->field_898 + addition[2] * 120.0;
    ...
    case 855:
        ...
        {
            char_pachou *pachou = (char_pachou *)chrt;
            float angl = (4 * pachou->field_898) + addition[3] * 60.0;
            float tx = cos_deg(angl) * (field_388 * 0.25 + 20.0) + (75 * pachou->dir) + pachou->x;
            float xx = tx - x;
        ...
        if ( get_subseq() == 1 )
        {
            ...
            char_pachou *pachou = (char_pachou *)chrt;
            float angl = (4 * pachou->field_898) + addition[3] * 60.0;
            x = cos_deg(angl) * (field_388 * 0.25 + 20.0) + (75 * pachou->dir) + pachou->x;
...
void patchouli_bullets::set_seq_params()
{
    h_inerc = 0.0;
    v_inerc = 0.0;
    field_378 = 0.0;
