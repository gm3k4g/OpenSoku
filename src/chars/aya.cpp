...
void char_aya::func10()
{
	...
	if ( get_seq() > 149 && get_seq() < 159 && !bbarrier_show ) 
	{
		...
		{
			addbullet(this, NULL, 998, (double)(57 * (char)dir), y + 94.0, dir, 1, NULL, 0);
		}
		if ( get_seq() > 153 && get_seq() < 158) 
		{
			addbullet(this, NULL, 998, (double)(57 * (char)dir) + x, y + 60.0, dir, 1, NULL, 0);
		}
		if ( get_seq() == 158 ) 
		{
			addbullet(this, NULL, 998, (double)(57 * (char)dir) + x, y + 100.0, dir, 1, NULL, 0);
		}
	}
